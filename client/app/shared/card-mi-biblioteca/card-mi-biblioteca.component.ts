...
export class CardMiBibliotecaComponent implements OnInit {
  chatStoriesFiltrados: Array<any> = new Array<any>();
  filtradosVacio = true;
  ...
  ngOnInit() {
    this.getBibliotecaByLoggedInUser();
  ...
  getBibliotecaByLoggedInUser() {
    this.biblioteca.getChatStoryBibliotecaByCurrentUserId().subscribe(
      (chatStoriesBiblioteca) => console.log(chatStoriesBiblioteca),
